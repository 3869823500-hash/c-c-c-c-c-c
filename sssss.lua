...
local function OhioWorking()
    ...
    UserInputService.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement and ballDragging then
    ...
    local function createToggle(text, def, cb)
        ...
        btn.Size = UDim2.new(1, -6, 1, -3)
        btn.Position = UDim2.new(0, 3, 0, 1.5)
